...
#define 	ROWS 		3
#define 	COLUMNS 	5
void input_arr(int rows, int columns, double arr[rows][columns]);
double ave_arr(int rows, int columns, double arr[rows][columns]);
double max_arr(int rows, int columns, double arr[rows][columns]);
void print_arr(int rows, int columns, double arr[rows][columns]);
